# Stage R106 Sandbox Artifact Catalog Global Top-Hypotheses Sidecar Report

Date: 2026-06-19
Owner: Codex Research Agent
Packet: `docs/work_packets/WPR106-339-sandbox-artifact-catalog-global-top-hypotheses-sidecar.md`

## Summary

WPR106-339 adds a catalog-owned
`sandbox_artifact_catalog_global_top_hypotheses.parquet` sidecar. The sidecar
flattens bounded `top_hypotheses` rows already present in loaded
...
The sidecar exposes source leaderboard paths, hypothesis/family identity,
tested dimensions, compact run/result/status counts, leaderboard decisions,
representative best-trial metadata, descriptor-only evidence-request trial IDs,
reason counts, and non-authorizing sandbox boundary flags. Catalogs with no
global top-hypothesis rows still write an empty-schema Parquet file for stable
automation.
